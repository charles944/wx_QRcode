...
<div class="layui-fluid">
	...
	<div class="portlet-title">
		<div class="actions" >
		        ...
		        <a id="optimize" class="layui-btn layui-btn-xs fbutton" href="<?php echo U('optimize');?>">优化表</a>
		        <a id="repair" class="layui-btn layui-btn-xs fbutton" href="<?php echo U('repair');?>">修复表</a>
		</div>
		<div class="clear"></div>
	</div>
		...
		<table class="layui-table" lay-even lay-skin="line">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?><tr>
                            <td class="check">
		                        <input class="ids" checked="checked" type="checkbox" name="tables[]" value="<?php echo ($table["name"]); ?>" />
		                      </td>
                            ...
                            <td class="action">
                                <a class="ajax-get no-refresh layui-btn layui-btn-xs hbutton btn_see" href="<?php echo U('optimize?tables='.$table['name']);?>">优化表</a>&nbsp;
                                <a class="ajax-get no-refresh layui-btn layui-btn-xs hbutton btn_see" href="<?php echo U('repair?tables='.$table['name']);?>">修复表</a>
                            </td>
