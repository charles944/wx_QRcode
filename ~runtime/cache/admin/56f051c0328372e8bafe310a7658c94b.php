...
<link rel="stylesheet" href="/public/js/codemirror/codemirror.css">
<link rel="stylesheet" href="/public/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
<style>
	...
	#preview_window.loading {
		background: url('/public/js/thinkbox/skin/default/tips_loading.gif') no-repeat center;
	}
	...
	<div class="layui-card">
		<div class="layui-card-body">
			...
			<div class="portlet-title">
				<div class="actions">
					<a id="addpack" class="layui-btn layui-btn-xs fbutton" href="<?php echo U('addpack');?>">新增补丁</a>
				</div>
				<div class="clear"></div>
			</div>
				...
				<table class="layui-table" lay-even lay-skin="line">
					...
					<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
								...
								<td class="action">
									<a class="ajax-get use db-import layui-btn layui-btn-xs hbutton btn_see" style="cursor: pointer;" href="<?php echo U('use_pack?id='.$data['id']);?>">使用</a>
									<a class="use layui-btn layui-btn-xs hbutton btn_edit" href="<?php echo U('addpack?id='.$data['id']);?>">编辑</a>
									<a id="" class="db-import view layui-btn layui-btn-xs hbutton btn_see" style="cursor: pointer" data="<?php echo ($data["id"]); ?>" type="button">查看</a>
									<a class="ajax-get layui-btn layui-btn-xs hbutton btn_trash" href="<?php echo U('del_pack?id='.$data['id']);?>"><i class="fa fa-trash"></i> 删除</a>
								</td>
...
<script type="text/javascript" src="/public/js/codemirror/clike.js"></script>
<script type="text/javascript" src="/public/js/codemirror/sql.js"></script>
