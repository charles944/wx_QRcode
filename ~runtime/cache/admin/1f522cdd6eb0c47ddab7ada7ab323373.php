...
<div class="layui-card qn-header">
	<div class="layui-breadcrumb">
		<a href="">首页</a>
		<a href="<?php echo U('index');?>">后台导航管理</a>
		<a href=""><cite><?php if(isset($data["title"])): ?>[ <?php echo ($data["title"]); ?> ] 子<?php endif; ?>菜单管理 </cite></a>
	</div>
</div>
<div class="layui-fluid">
	...
	<div class="portlet-title">
		<div class="actions">
				<a class="layui-btn layui-btn-xs fbutton" href="<?php echo U('add',array('pid'=>I('get.pid',0)));?>">新 增</a>
				<a class="layui-btn layui-btn-xs fbutton ajax-post confirm" url="<?php echo U('del');?>" target-form="ids" data-toggle="confirmation">删 除</a>
		        <a class="layui-btn layui-btn-xs fbutton" href="<?php echo U('import',array('pid'=>I('get.pid',0)));?>">导 入</a>
		        <button class="list_sort layui-btn layui-btn-xs fbutton" url="<?php echo U('sort',array('pid'=>I('get.pid',0)),'');?>">排序</button>
		</div>
		<div class="clear"></div>
	</div>
		...
		<table class="layui-table" lay-even lay-skin="line">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                   	<td class="check">
                       <input class="ids" type="checkbox" name="ids[]" value="<?php echo ($menu["id"]); ?>" lay-skin="primary" lay-filter="ids"/>
                    </td>
                       ...
                       <td>
                           <a title="编辑" class="layui-btn layui-btn-xs hbutton btn_edit" href="<?php echo U('edit?id='.$menu['id']);?>"><i class="fa fa-edit"></i> 编辑</a>
                           <a class="ajax-get layui-btn layui-btn-xs hbutton btn_trash" title="删除" href="<?php echo U('del?ids='.$menu['id']);?>">删除</a>
                       </td>
