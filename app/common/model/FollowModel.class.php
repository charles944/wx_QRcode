...
class FollowModel extends Model
{
    ...
    public function follow($uid)
    {
        ...
        D('Common/Message')->sendMessage($uid, '粉丝数增加' ,  $user['nickname'] . ' 关注了你。', 'Ucenter/Index/index',array('uid'=>is_login()));
    ...
    public function unfollow($uid)
    {
        ...
        D('Common/Message')->sendMessage($uid, '粉丝数减少' ,  $user['nickname'] . ' 取消了对你的关注。', 'Ucenter/Index/index',array('uid'=>is_login()));
    ...
    public function addFollow($who_follow, $follow_who,$invite=0)
    {
        ...
        D('Common/Message')->sendMessage($follow_who, '粉丝数增加' ,  $content, 'Ucenter/Index/index',array('uid'=>$who_follow),$who_follow);
