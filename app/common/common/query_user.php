...
{
    return D('User/User')->query_user($fields, $uid);
}

function read_query_user_cache($uid, $field)
{

    return D('User/User')->read_query_user_cache($uid, $field);
}

function write_query_user_cache($uid, $field, $value)
{
    return D('User/User')->write_query_user_cache($uid, $field, $value);
}
...
{
    D('User/User')->clean_query_user_cache($uid, $field);
}